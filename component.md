...
| 平台     | 特点                     | 插件下载                                     |
| ------ | ---------------------- | ---------------------------------------- |
| 又拍云    | 申请加入联盟可享每月免费15G流量、图片处理 | [下载](http://www.fastadmin.net/store/upyun.html) |
| 七牛云    | 实名认证后免费10G流量、稳定、图片处理   | [下载](http://www.fastadmin.net/store/qiniu.html) |
...
| 属性                  | 描述                                       | 示例                                   |
| ------------------- | ---------------------------------------- | ------------------------------------ |
| data-format         | 日期时间的格式，支持[Moment.js](http://momentjs.com/docs/#/displaying/format/)的格式 | data-format=" YYYY-MM-DD"            |
...
更多的使用方法请参考[Bootstrap-datetimepicker官方教程](http://eonasdan.github.io/bootstrap-datetimepicker/)
...
更多的使用方法请参考：[Selectpicker官方教程](http://silviomoreto.github.io/bootstrap-select/)
